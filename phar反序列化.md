...
这是CISCN2019的一道题目，是关于phar反序列化的。

![image-20210318000830996](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318000830996.png)

进去是个登录框，随便注册个账号就进去了

![image-20210318001453539](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318001453539.png)

这里有存在一个任意文件下载的漏洞，利用bp抓包修改一下filename就行了

![image-20210318001611709](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318001611709.png)

![image-20210318001920704](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318001920704.png)

依据源文件下载到了其他的文件

![image-20210318002009589](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318002009589.png)

![image-20210318002020392](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318002020392.png)

这里的filename的参数是可控的，但是我们无法进行绕过

![image-20210318002056497](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318002056497.png)

这里有个魔术方法，可以使用phar反序列化

![image-20210318002427628](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318002427628.png)
...
用bp抓包把文件类型改为image/gif

接着把上传的文件删除

抓包修改filename=phar://test.gif

在bp的重放器就能看到flag了

![image-20210318003054759](https://lamcheukwing.oss-cn-shenzhen.aliyuncs.com/img/image-20210318003054759.png)